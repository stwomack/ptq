...
WWT:
cf cups ess-postgres -p '{"hostname":"10.255.178.40","port":"5432","name":"mcdb","username":"rdr_user_rl","password":"pivotal","uri":"postgresql://gpadmin:gpadmin@10.255.178.40:5432/mcdb?reconnect=true","jdbcUrl":"jdbc:postgresql://10.255.178.40:5432/mcdb?user=rdr_user_rl"}'
