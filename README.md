...
Look at the script & assert that your concourse endpoint, and user auth (-u|-p) are properly configured for your concourse environment. See the following detailed instructions for concourse itself, if needed.
